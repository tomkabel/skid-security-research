...
Käesolevaga väidan, et **Smart-ID** ja selle uusima iteratsiooni **Smart-ID+** praegune haavatavus ründemeetodile nimega *QRLJackinguks* ei ole juhuslik koodiviga ega järelevalve puudumine. See on teenusepakkuja, **SK ID Solutions AS-i**, kalkuleeritud ja teadlik arhitektuuriline valik. Tõendid näitavad, et ettevõte on otsustanud eelistada kasutusmugavust ja arenduskiirust kriitilisele turvalisusele, jättes "tagaukse" lahti rünnakutele, mida on võimalik ja vajalik vältida. See ei ole viga. See on SK ID Solutions AS-i kalkuleeritud otsus.
...
Mul on tõendid vastupidise kohta. Kui Abel raporteeris vastutustundliku avalikustamise (*Responsible Disclosure*) raames, et isegi uus **Smart-ID+** on haavatav vahemeherünnakutele (MITM), oli SK ID vastus jahmatavalt otsekohene.
...
Siinkohal peame küsima: mis valik on tavalisel eestlasel? Me oleme pantvangis. Kui mulle ei meeldi mu panga turvapoliitika, võin ma panka vahetada. Kui mulle ei meeldi Gmaili privaatsuspoliitika, võin ma kolida ProtonMaili. Aga Eestis on SK ID Solutionsil *de facto* monopol. Ilma Smart-IDta oled sa digitaalne paaria. Sa ei saa hääletada, sa ei saa makse maksta, sa ei saa arsti juurde aega kinni panna.
...
SK ID põhiline kaitseargument on alati olnud "kasutajamugavus" (*usability*). Kriitikud ja SK ID PR-osakond väidavad kindlasti, et tehnoloogia on keeruline ja "me tegeleme sellega". Nad väidavad, et täiendavad turvameetmed muudaksid teenuse kasutamise liiga keeruliseks. See on iganenud ja eksitav väide.

Jutt sellest, et turvalisus tapab mugavuse, on iganenud vale. Vaadake FIDO2 standardit. Vaadake WebAuthni. Maailmas on olemas lahendused, mis seovad sessiooni matemaatiliselt ja purunematult konkreetse seadmega, ilma et kasutaja peaks tegema kätelseisu. Mugavus ja turvalisus saavad eksisteerida koos, kui teenusepakkujal on viitsimist investeerida kaasaegsesse arhitektuuri.
