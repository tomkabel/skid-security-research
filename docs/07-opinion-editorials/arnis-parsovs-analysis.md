---
title: Arnis Paršovs Analysis
description: Analysis of Arnis Paršovs' Smart-ID security critique and main arguments
---
...
**Original Publication:** "Pangad ei kasuta Smart-ID õngitsusrünnete vastaseid meetmeid" (Banks do not use measures against Smart-ID phishing attacks)
**Author:** Arnis Paršovs, Cybersecurity Researcher, University of Tartu
**Publication:** ERR (Estonian Public Broadcasting), January 2026
**Link:** https://news.err.ee/1609910821/arnis-parsovs-banks-fail-to-implement-measures-against-smart-id-phishing
...
The original Estonian-language article by Arnis Paršovs, "Pangad ei kasuta Smart-ID õngitsusrünnete vastaseid meetmeid," was lawfully published by ERR (Estonian Public Broadcasting) in January 2026 (see [Source](#source) above for author, title, and publication details). Excerpts are quoted in translation throughout this analysis for the purpose of academic commentary and critique, limited in extent to what that commentary requires, with the author, work title, and source publication credited as required. This relies on § 19(1) of the Estonian Copyright Act (Autoriõiguse seadus) — the free-use exception for quotations and summaries from a lawfully published work, to the extent justified by the purpose of the commentary ([official consolidated text, in force from 1 October 2025](https://www.riigiteataja.ee/en/eli/ee/520102025003/consolide)). This site is publicly deployed with no single governing jurisdiction designated, so no claim is made here about how any other jurisdiction's doctrine (e.g., U.S. "fair use") would apply; the Estonian statutory exception is cited because the source article and its author are Estonian. Readers relying on more extensive reproduction of the original, or reproduction for a different purpose, should consult the Act directly, seek permission from ERR/the author, and obtain their own legal review before publishing further translated excerpts.
