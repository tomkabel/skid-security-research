...
**Evidence:** SK ID Solutions has acknowledged this vulnerability in written correspondence (December 5, 2025), stating the flaw was known during development and was "consciously accepted" for a period. The company has since marked the CVE entry as DISPUTED, classifying the attack vector as an architectural feature rather than a vulnerability.
