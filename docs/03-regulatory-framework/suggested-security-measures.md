...
## [](https://sk-eid.github.io/smart-id-documentation/rp-api/additional_security_measures.html#_keeping_track_of_trusted_and_unknown_browsers)Keeping track of trusted and unknown browsers
...
## [](https://sk-eid.github.io/smart-id-documentation/rp-api/additional_security_measures.html#_keeping_track_of_suspicious_and_malicious_ip_addresses)Keeping track of suspicious and malicious IP addresses
...
## [](https://sk-eid.github.io/smart-id-documentation/rp-api/additional_security_measures.html#allowing-users-to-verify-operations)Allowing users to verify operations
...
## [](https://sk-eid.github.io/smart-id-documentation/rp-api/additional_security_measures.html#_monitoring_usage_patterns)Monitoring usage patterns
...
2.   some source (IP address, browser, phone number, e-mail address) behaves in a weird way and perhaps should be more closely monitored or added to a blocklist;

3.   some logs might indicate that there’s an unknown vulnerability in the RP’s website.

## [](https://sk-eid.github.io/smart-id-documentation/rp-api/additional_security_measures.html#_responding_to_security_incidents)Responding to security incidents
...
## [](https://sk-eid.github.io/smart-id-documentation/rp-api/additional_security_measures.html#_personal_data_processing)Personal data processing
