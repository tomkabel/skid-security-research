# Additional Security Measures for Smart-ID

This page lists additional security measures which can be deployed by the RP (Relying Party) in order to protect from phishing threats and attacks.
