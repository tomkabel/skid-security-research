# 1. Agency Analysis: RIA (State Information System Authority)
...
* **Violation of eIDAS Article 19 (Security requirements):**
  * *Law:* Article 19(1) mandates that Trust Service Providers take "appropriate technical and organisational measures to manage the risks posed to the security of the trust services... having regard to the state of the art."
...
* **Violation of eIDAS Article 24 (Requirements for QTSPs):**
  * *Law:* Article 24(2)(e) states a QTSP must "use trustworthy systems and products that are protected against modification and ensure the technical security and reliability of the processes supported by them."
  * *Breach:* A system that allows session hijacking via simple MITM is arguably not "trustworthy" for High Assurance actions (e.g., bank transfers, signing laws).
* **EUTS § 14 (Supervision):**
  * *Power:* RIA has the direct mandate to supervise compliance. If a QTSP fails to meet security requirements, RIA can suspend or revoke the "Qualified" status (EUTS § 17-19 context).

### Recommended Regulatory Action (RIA)

RIA must issue an immediate **Precept (Ettekirjutus)** under **EUTS** and the **Cybersecurity Act (KüTS)**. The admission that risk was "accepted" invalidates the certification audit, as the audit relies on the premise that all *critical* risks are mitigated, not merely "accepted" for convenience.

---

# 2. Agency Analysis: TTJA (Consumer Protection & Technical Regulatory Authority)
...
* **TKS (Consumer Protection Act) § 16 (Misleading Omission):**
  * *Law:* A trading practice is misleading if it omits material information that the average consumer needs to take an informed transactional decision.
  * *Breach:* SK ID markets the service as "Secure." They *omitted* the material fact that they "knowingly accepted" a flaw allowing identity theft via MITM. Had consumers (or banks) known this, they might have chosen ID-card or Mobile-ID instead.
* **TKS § 12 (Misleading Trading Practices):**
  * *Law:* Providing false information or deceiving the consumer regarding the main characteristics of the product (including risks and security).
...
### Recommended Regulatory Action (TTJA)
...
# 3. Agency Analysis: AKI (Data Protection Inspectorate)
...
* **GDPR Article 25 (Data Protection by Design and by Default):**
  * *Law:* Controllers must implement appropriate technical measures *at the time of the determination of the means for processing* and *at the time of the processing itself*.
...
* **GDPR Article 32 (Security of Processing):**
  * *Law:* Requires a process for regularly testing, assessing, and evaluating the effectiveness of technical measures.
...
### Recommended Regulatory Action (AKI)
...
# 4. Counter-Argument Strategy: Dismantling "Risk Acceptance"

**The Defense:** SK ID claims they "balanced security, usability, and complexity" and "accepted the risk."

**The Rebuttal (Legal Logic):**

1. **Non-Transferable Risk:** In a strictly private contract (e.g., a gaming forum), a provider can accept risk. In **National Trust Services**, the risk is not SK ID's to accept. The risk falls on the *User* (stolen funds) and the *State* (legal integrity). You cannot accept risk for a third party without their informed consent.
2. **eIDAS Hierarchy:** The "Level High" (Kõrge tase) assurance requirements under eIDAS are statutory minimums, not suggestions. A known architectural hole that facilitates MITM contradicts the technical specifications for "High" assurance which requires "substantial resistance" to attacker capability.
3. **Cost vs. Safety:** Under product liability laws and GDPR, "implementation complexity" (i.e., cost) is not a valid legal defense for leaving a known critical vulnerability in a mass-market security product.

---

# 5. Draft Precept Template (For RIA)

**NOTICE OF ADMINISTRATIVE PRECEPT / HALDUSAKTI EELNÕU**
...
3. **Penalty Warning (Sunniraha):** Failure to comply by [Date] will result in a non-compliance levy of **10,000 EUR** per week and potential suspension of "Qualified Trust Service Provider" status for the Smart-ID service.
...
# 6. Conclusion: Regulatory Action Plan & Charge Sheet

The user's evidence proves that the vulnerability is not a bug, but a **business decision**. This requires a coordinated punitive response.
